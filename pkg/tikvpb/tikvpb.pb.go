...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_RawGetByIndex
	//	*BatchCommandsRequest_Request_RawBatchGetByIndex
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{0, 0}
}
...
type BatchCommandsRequest_Request_RawGetByIndex struct {
	RawGetByIndex *kvrpcpb.RawGetByIndexRequest `protobuf:"bytes,102,opt,name=RawGetByIndex,oneof"`
}
type BatchCommandsRequest_Request_RawBatchGetByIndex struct {
	RawBatchGetByIndex *kvrpcpb.RawBatchGetByIndexRequest `protobuf:"bytes,103,opt,name=RawBatchGetByIndex,oneof"`
}
...
func (*BatchCommandsRequest_Request_RawGetByIndex) isBatchCommandsRequest_Request_Cmd()       {}
func (*BatchCommandsRequest_Request_RawBatchGetByIndex) isBatchCommandsRequest_Request_Cmd()  {}
...
func (m *BatchCommandsRequest_Request) GetRawGetByIndex() *kvrpcpb.RawGetByIndexRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_RawGetByIndex); ok {
		return x.RawGetByIndex
	}
	return nil
}

func (m *BatchCommandsRequest_Request) GetRawBatchGetByIndex() *kvrpcpb.RawBatchGetByIndexRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_RawBatchGetByIndex); ok {
		return x.RawBatchGetByIndex
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_RawGetByIndex)(nil),
		(*BatchCommandsRequest_Request_RawBatchGetByIndex)(nil),
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_RawGetByIndex:
		_ = b.EncodeVarint(102<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawGetByIndex); err != nil {
			return err
		}
	case *BatchCommandsRequest_Request_RawBatchGetByIndex:
		_ = b.EncodeVarint(103<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawBatchGetByIndex); err != nil {
			return err
		}
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 101: // cmd.RawBatchUpdate
		...
		return true, err
	case 102: // cmd.RawGetByIndex
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawGetByIndexRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_RawGetByIndex{msg}
		return true, err
	case 103: // cmd.RawBatchGetByIndex
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawBatchGetByIndexRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_RawBatchGetByIndex{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func _BatchCommandsRequest_Request_OneofSizer(msg proto.Message) (n int) {
	...
	case *BatchCommandsRequest_Request_RawBatchUpdate:
		...
		n += s
	case *BatchCommandsRequest_Request_RawGetByIndex:
		s := proto.Size(x.RawGetByIndex)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *BatchCommandsRequest_Request_RawBatchGetByIndex:
		s := proto.Size(x.RawBatchGetByIndex)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *BatchCommandsRequest_Request_Empty:
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_RawGetByIndex
	//	*BatchCommandsResponse_Response_RawBatchGetByIndex
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{1, 0}
}
...
type BatchCommandsResponse_Response_RawGetByIndex struct {
	RawGetByIndex *kvrpcpb.RawGetByIndexResponse `protobuf:"bytes,102,opt,name=RawGetByIndex,oneof"`
}
type BatchCommandsResponse_Response_RawBatchGetByIndex struct {
	RawBatchGetByIndex *kvrpcpb.RawBatchGetByIndexResponse `protobuf:"bytes,103,opt,name=RawBatchGetByIndex,oneof"`
}
...
func (*BatchCommandsResponse_Response_RawGetByIndex) isBatchCommandsResponse_Response_Cmd()       {}
func (*BatchCommandsResponse_Response_RawBatchGetByIndex) isBatchCommandsResponse_Response_Cmd()  {}
...
func (m *BatchCommandsResponse_Response) GetRawGetByIndex() *kvrpcpb.RawGetByIndexResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_RawGetByIndex); ok {
		return x.RawGetByIndex
	}
	return nil
}

func (m *BatchCommandsResponse_Response) GetRawBatchGetByIndex() *kvrpcpb.RawBatchGetByIndexResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_RawBatchGetByIndex); ok {
		return x.RawBatchGetByIndex
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_RawGetByIndex)(nil),
		(*BatchCommandsResponse_Response_RawBatchGetByIndex)(nil),
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_RawGetByIndex:
		_ = b.EncodeVarint(102<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawGetByIndex); err != nil {
			return err
		}
	case *BatchCommandsResponse_Response_RawBatchGetByIndex:
		_ = b.EncodeVarint(103<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawBatchGetByIndex); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 102: // cmd.RawGetByIndex
		...
		msg := new(kvrpcpb.RawGetByIndexResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_RawGetByIndex{msg}
		return true, err
	case 103: // cmd.RawBatchGetByIndex
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawBatchGetByIndexResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_RawBatchGetByIndex{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_47a103754054c57d, []int{4}
}
...
type TikvClient interface {
	...
	RawGetByIndex(ctx context.Context, in *kvrpcpb.RawGetByIndexRequest, opts ...grpc.CallOption) (*kvrpcpb.RawGetByIndexResponse, error)
	RawBatchGetByIndex(ctx context.Context, in *kvrpcpb.RawBatchGetByIndexRequest, opts ...grpc.CallOption) (*kvrpcpb.RawBatchGetByIndexResponse, error)
...
func (c *tikvClient) RawGetByIndex(ctx context.Context, in *kvrpcpb.RawGetByIndexRequest, opts ...grpc.CallOption) (*kvrpcpb.RawGetByIndexResponse, error) {
	out := new(kvrpcpb.RawGetByIndexResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawGetByIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tikvClient) RawBatchGetByIndex(ctx context.Context, in *kvrpcpb.RawBatchGetByIndexRequest, opts ...grpc.CallOption) (*kvrpcpb.RawBatchGetByIndexResponse, error) {
	out := new(kvrpcpb.RawBatchGetByIndexResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawBatchGetByIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	RawGetByIndex(context.Context, *kvrpcpb.RawGetByIndexRequest) (*kvrpcpb.RawGetByIndexResponse, error)
	RawBatchGetByIndex(context.Context, *kvrpcpb.RawBatchGetByIndexRequest) (*kvrpcpb.RawBatchGetByIndexResponse, error)
...
func _Tikv_RawGetByIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawGetByIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawGetByIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawGetByIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawGetByIndex(ctx, req.(*kvrpcpb.RawGetByIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Tikv_RawBatchGetByIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawBatchGetByIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawBatchGetByIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawBatchGetByIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawBatchGetByIndex(ctx, req.(*kvrpcpb.RawBatchGetByIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RawGetByIndex",
			Handler:    _Tikv_RawGetByIndex_Handler,
		},
		{
			MethodName: "RawBatchGetByIndex",
			Handler:    _Tikv_RawBatchGetByIndex_Handler,
		},
		{
			MethodName: "RawPut",
...
func (m *BatchCommandsRequest_Request_RawUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawUpdate != nil {
		...
		n29, err := m.RawUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *BatchCommandsRequest_Request_RawBatchUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchUpdate != nil {
		...
		n30, err := m.RawBatchUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *BatchCommandsRequest_Request_RawGetByIndex) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawGetByIndex != nil {
		dAtA[i] = 0xb2
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawGetByIndex.Size()))
		n31, err := m.RawGetByIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *BatchCommandsRequest_Request_RawBatchGetByIndex) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawBatchGetByIndex != nil {
		dAtA[i] = 0xba
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchGetByIndex.Size()))
		n32, err := m.RawBatchGetByIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *BatchCommandsResponse_Response_RawUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawUpdate != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawUpdate.Size()))
		n62, err := m.RawUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *BatchCommandsResponse_Response_RawBatchUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchUpdate != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchUpdate.Size()))
		n63, err := m.RawBatchUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *BatchCommandsResponse_Response_RawGetByIndex) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawGetByIndex != nil {
		dAtA[i] = 0xb2
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawGetByIndex.Size()))
		n64, err := m.RawGetByIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *BatchCommandsResponse_Response_RawBatchGetByIndex) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawBatchGetByIndex != nil {
		dAtA[i] = 0xba
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchGetByIndex.Size()))
		n65, err := m.RawBatchGetByIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *BatchCommandsRequest_Request_RawGetByIndex) Size() (n int) {
	var l int
	_ = l
	if m.RawGetByIndex != nil {
		l = m.RawGetByIndex.Size()
		n += 2 + l + sovTikvpb(uint64(l))
	}
	return n
}
func (m *BatchCommandsRequest_Request_RawBatchGetByIndex) Size() (n int) {
	var l int
	_ = l
	if m.RawBatchGetByIndex != nil {
		l = m.RawBatchGetByIndex.Size()
		n += 2 + l + sovTikvpb(uint64(l))
	}
	return n
}
...
func (m *BatchCommandsResponse_Response_RawGetByIndex) Size() (n int) {
	var l int
	_ = l
	if m.RawGetByIndex != nil {
		l = m.RawGetByIndex.Size()
...
func (m *BatchCommandsResponse_Response_RawBatchGetByIndex) Size() (n int) {
	var l int
	_ = l
	if m.RawBatchGetByIndex != nil {
		l = m.RawBatchGetByIndex.Size()
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 102:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawGetByIndex", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.RawGetByIndexRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_RawGetByIndex{v}
			iNdEx = postIndex
		case 103:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawBatchGetByIndex", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.RawBatchGetByIndexRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_RawBatchGetByIndex{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 102:
			...
			v := &kvrpcpb.RawGetByIndexResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_RawGetByIndex{v}
			iNdEx = postIndex
		case 103:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawBatchGetByIndex", wireType)
			...
			v := &kvrpcpb.RawBatchGetByIndexResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_RawBatchGetByIndex{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Empty", wireType)
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_47a103754054c57d) }

var fileDescriptor_tikvpb_47a103754054c57d = []byte{
	// 1850 bytes of a gzipped FileDescriptorProto
	,
}
